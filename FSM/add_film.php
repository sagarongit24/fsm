...
<body>
    ...
    <form action="insert_film.php" method="post">
        ...
        <!-- "film_id" will be generated by the database, so no need for user input -->
        <!-- <label for="film_id">Film ID:</label>
        <input type="number" id="film_id" name="film_id"><br> -->
        ...
        <!-- The "review_id" input field has been removed -->
